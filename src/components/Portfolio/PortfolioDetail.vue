...
<template>
    <div class="rounded-md h-full w-full absolute inset-x-0 bottom-0 shadow-md bg-primary-light-200 dark:bg-primary-dark-300">
        <div class="container mx-auto py-[25px] h-full scrollbar-hidden  overflow-y-auto overflow-x-hidden">
            ...
            <div class="flex flex-col lg:flex-row gap-4 overflow-y-auto scrollbar-hidden     overflow-x-hidden">
